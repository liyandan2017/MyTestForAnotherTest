...
public class  DevsettingsgzoneListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devsettingsgzone_list);

        mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.pull_refresh_settingsgzone_list);
        ...
        mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
            ...
            public void onLastItemVisible() {
                Toast.makeText(DevsettingsgzoneListActivity.this, "End of List!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
        ...
        protected String[] doInBackground(Void... params) {
            ...
            try {
                //获取数据库的数据，更新mStrings.
                String test[]={ "设备定设定值", "设备定值组", "PT定值区" };
                mStrings = test;
                Thread.sleep(4000);
    ...
    private String[] mStrings = { "设备定设定值", "设备定值组", "PT定值区", };
