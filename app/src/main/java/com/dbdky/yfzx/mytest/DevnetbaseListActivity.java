...
public class DevnetbaseListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devnetbase_list);

        mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.pull_refresh_devnetbase_list);
        ...
        mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
            ...
            public void onLastItemVisible() {
                Toast.makeText(DevnetbaseListActivity.this, "End of List!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
        ...
        protected String[] doInBackground(Void... params) {
            ...
            try {
                //获取数据库的数据，更新mStrings.
                //TODO 根据各地区 厂站表查询设备联通对比率，动态生成列表结构和信息
                String test[]={"沈阳局：    五爱变电站", "设备连通率:    98.67%"};
                mStrings = test;
                Thread.sleep(4000);
    ...
    private String[] mStrings = { "沈阳局五爱变电站:    ", "设备连通率:    "};
