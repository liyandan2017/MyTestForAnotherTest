 ...
 * @author hellogv
 */
public class GuzhangbaogaoListActivity extends Activity {
    /** Called when the activity is first created. */
    ListView lv;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guzhangbaogao_list);
        this.setTitle("运维信息展示");
        lv = (ListView) this.findViewById(R.id.ListViewGuzhangbaogaoList);
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Toast.makeText(GuzhangbaogaoListActivity.this, "选中第"+String.valueOf(arg2)+"行", 500).show();
        }
    }
}
