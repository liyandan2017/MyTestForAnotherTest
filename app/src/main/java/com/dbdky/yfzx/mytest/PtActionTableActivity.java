 ...
 * @author hellogv
 */
public class PtActionTableActivity extends Activity {
    /** Called when the activity is first created. */
    ListView lv;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pt_action_table);
        this.setTitle("全网最新N条动作");
        lv = (ListView) this.findViewById(R.id.ListViewPtAction);
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Toast.makeText(PtActionTableActivity.this, "选中第"+String.valueOf(arg2)+"行", 500).show();
        }
    }
}
