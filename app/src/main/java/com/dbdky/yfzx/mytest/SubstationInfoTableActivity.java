 ...
 * @author hellogv
 */
public class SubstationInfoTableActivity extends Activity {
    /** Called when the activity is first created. */
    ListView lv;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_substation_info_table);
        this.setTitle("各场站基本信息及其状态");
        lv = (ListView) this.findViewById(R.id.ListViewSubstationInfo);
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Toast.makeText(SubstationInfoTableActivity.this, "选中第"+String.valueOf(arg2)+"行", 500).show();
        }
    }
}
