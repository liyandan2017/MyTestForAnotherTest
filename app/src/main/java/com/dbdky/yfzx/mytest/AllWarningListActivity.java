...
public class AllWarningListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_warning_list);

        mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.pull_refresh_allwarning_list);
        ...
        mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
            ...
            public void onLastItemVisible() {
                Toast.makeText(AllWarningListActivity.this, "End of List!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
        ...
        protected String[] doInBackground(Void... params) {
            ...
            try {
                //获取数据库的数据，更新mStrings.
                String test[]={ "定值不一致", "定值区不一致", "软压板不一致", "频繁告警", "频繁变位",
                        "频繁录波", "频发动作"};
                mStrings = test;
                Thread.sleep(4000);
    ...
    private String[] mStrings = { "定值", "定值区", "软压板", "频繁告警", "频繁变位",
            "频繁录波", "频发动作"};
