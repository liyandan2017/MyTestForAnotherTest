...
public class ManufactureStationStatListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manufacture_station_stat_list);

        mPullRefreshListView = (PullToRefreshListView) findViewById(R.id.pull_refresh_manufacturestationstat_list);
        ...
        mPullRefreshListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
            ...
            public void onLastItemVisible() {
                Toast.makeText(ManufactureStationStatListActivity.this, "End of List!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class GetDataTask extends AsyncTask<Void, Void, String[]> {
        ...
        protected String[] doInBackground(Void... params) {
            ...
            try {
                //获取数据库的数据，更新mStrings.
                String test[]={ "中分子站占比:    30.67%", "中分子站连通率:    95.69%","宁波理工子站占比:    34.28%", "宁波理工子站连通率:    89.75%"};
                mStrings = test;
                Thread.sleep(4000);
    ...
    private String[] mStrings = { "中分子站占比:    ", "中分子站连通率:    ","宁波理工子站占比:    ", "宁波理工子站连通率:    ", };
