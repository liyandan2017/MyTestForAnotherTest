 ...
 * @author hellogv
 */
public class SecdevTableActivity extends Activity {
    /** Called when the activity is first created. */
    ListView lv;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_secdev_table);
        this.setTitle("全网设备基本信息及其状态");
        lv = (ListView) this.findViewById(R.id.ListViewSecDevTable);
    ...
    class ItemClickEvent implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                long arg3) {
            Toast.makeText(SecdevTableActivity.this, "选中第"+String.valueOf(arg2)+"行", 500).show();
        }
    }
}
